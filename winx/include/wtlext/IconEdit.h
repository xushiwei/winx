...
class CIconEditT : public CWindowImpl<CIconEditT<TBASE>, TBASE>
{
...
// OCM_CTLCOLOREDIT message must be chained down to baseClass before it get to 
//	thisClass::OnCtlColorEdit() handler
...
#endif // #if defined(WINX_REFLECT_CTLCOLOR)
