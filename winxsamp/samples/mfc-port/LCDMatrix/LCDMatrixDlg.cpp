...
/* @@code delete
CLCDMatrixDlg::CLCDMatrixDlg(CWnd* pParent)
...
BOOL CLCDMatrixDlg::OnInitDialog(HWND hDlg, HWND hWndDefaultFocus)
{
	...
	*/
	...
	winx::SubclassDlgItem(&m_lcdleft, hDlg, IDC_LCDLEFT);
	winx::SubclassDlgItem(&m_lcdstaticsmall, hDlg, IDC_MATRIXSMALL);
	winx::SubclassDlgItem(&m_lcddown, hDlg, IDC_MATRIXDOWN);
	winx::SubclassDlgItem(&m_lcddown2, hDlg, IDC_MATRIXDOWN2);
...
void CLCDMatrixDlg::OnClose(HWND hWnd) 
{
