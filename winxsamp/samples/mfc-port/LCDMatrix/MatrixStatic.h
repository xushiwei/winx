...
//class CMatrixStatic : public CStatic //@@code modify -->
class CMatrixStatic : public Static<CMatrixStatic>
{
	WINX_CLASS("WinxMatrixStatic"); //@@code insert: removing it is also ok.
// Construction
public:
...
typedef CMatrixStatic MatrixStatic; //@@code insert: alias name
